...
_CONFIGS = [
    ...
    TrainConfig(
        # Con1 stage 1: use a meaningful partial action hypothesis to
        # disambiguate the released JEPA-WAM transition prior.  All released
        # checkpoint parameters remain frozen.
        name="pi05_libero_actr_stage1",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
            ...
            vjepa_target_grid_size=24,
            vjepa_target_dim=1408,
            vjepa_compact_target_dim=256,
            vjepa_aux_weight=0.1,
            vjepa_aux_warmup_steps=200,
            vjepa_action_attends_queries=False,
            vjepa_disable_geometric_augmentation=True,
            use_actr=True,
            actr_stage=1,
            actr_interaction_dim=256,
            actr_num_heads=8,
            actr_ffn_dim=512,
            actr_flow_onset=0.5,
    ...
    TrainConfig(
        # Con1 stage 2: close the ordered A->R->A loop and train the same
        # bridge with action-flow plus transition supervision.
        name="pi05_libero_actr_stage2",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        ema_decay=0.999,
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "./data/weights/pi05_jepawam_actr_stage1/params",
            missing_regex=".*actr.*",
        ),
        freeze_filter=pi0_config.Pi0Config(
            pi05=True,
